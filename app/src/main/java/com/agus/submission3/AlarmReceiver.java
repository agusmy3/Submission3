...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void setRepeatingAlarm(Context context, String time, String title, String message) {
        ...
        Toast.makeText(context, R.string.set_remind, Toast.LENGTH_SHORT).show();
    }
